 ...
 * Optional OST: link SDL2_mixer and implement play_music_ost() for BGM.
 *
 * ═══════════════════════════════════════════════════════════════════════════
...
// ─── Dynamic Sound Engine (SFX + OST hook) ─────────────────────────────────
...
public:
    ...
    void play_music_ost(const char* path) {
        (void)path;
        // OST: Add SDL_mixer and Mix_PlayMusic(Mix_LoadMUS(path), -1) for real BGM.
    }
};
